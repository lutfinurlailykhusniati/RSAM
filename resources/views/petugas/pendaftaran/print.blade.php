...
<body>  
  <br>
        ...
        <div><br>
          ...
          <center><div style="text-transform: capitalize; font-size: 18pt">Poli : {{ $poly->nama_poliklinik }}</div></center>
          <center><div style="text-transform: capitalize; font-size: 14pt">Dokter: {{ $dokter->nama }}</div></center><br><br><br>
          ...
          <center><div style=" font-size: 16pt">{{ date('d F Y', strtotime($booking->tanggal_jadwal))}}</div></center>
