        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">      
                    ...
                    @endif
                    <a href="{{ url('/tambah-jadwal') }}"  class="btn btn-primary">Tambah Jadwal</a><br><br>
                        ...
                        <table id="zero_config" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="center">  
                                        <a href="{{ url('/edit-jadwal/'.$jadwal->id.'/'.$jadwal->id_hari) }}"  class="btn btn-success btn-sm">Edit</a>
                                        <a href="{{ url('/delete-jadwal/'.$jadwal->id.'/'.$jadwal->id_hari) }}" class="btn btn-danger btn-sm">Delete</a>  
                                    </td> 
                                </tr>
                              	@endforeach
